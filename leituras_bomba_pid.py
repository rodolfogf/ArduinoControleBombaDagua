...
leituras = pd.read_csv(
    r'C:\_UEMG\Disciplinas\Controle e Servomecanismo\Trabalho1_ControleBomba2\LeiturasPID_Correção_Manual.csv',
    sep=';')
...
leituras['tempo'] = leituras['tempo'].apply(lambda y: y - 3)
